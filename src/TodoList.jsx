                ...
                <div className="card">
                    {incompleteTodos.map((todo) => (
                        <div key={todo.id}>
                            <h4>{todo.title}</h4>
                            <p>{todo.content}</p>
                            <button className="buttons" onClick={() => removeTodo(todo.id)}>
                                삭제
                            </button>
                            <button className="button" onClick={() => completeTodo(todo.id)}>
                                완료
                            </button>
                        </div>
                    ))}
                ...
                <div className="card">
                    {completedTodos.map((todo) => (
                        <div key={todo.id}>
                            ...
                            <button className="button" onClick={() => undoComplete(todo.id)}>
                                되돌리기
                            </button>
                        </div>
                    ))}
